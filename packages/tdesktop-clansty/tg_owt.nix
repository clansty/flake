...
, mesa, libepoxy, libglvnd, unstableGitUpdater, darwin, python3
}:

stdenv.mkDerivation {
  pname = "tg_owt";
  version = "0-unstable-4a60ce1ab9fdb962004c6a959f682ace3db50cbd";

  src = fetchFromGitHub {
    owner = "desktop-app";
    repo = "tg_owt";
    rev = "4a60ce1ab9fdb962004c6a959f682ace3db50cbd";
    sha256 = "sha256-snT7EfXQYpeh6pT+1UILjtLWSLr0yg46l1/mDjH+VHg=";
    fetchSubmodules = true;
  };

  outputs = [ "out" "dev" ];

  nativeBuildInputs = [ pkg-config cmake ninja yasm python3 ];
